...
#############################################################################
runner = dict(max_iters=160000//(gpu_multipliers//2), work_dir='/mnt/bn/fqh-bytenas-data3/RMT_Uper_l_2x')
checkpoint_config = dict(max_keep_ckpts=1, interval=8000//(gpu_multipliers//2))
evaluation = dict(interval=8000//(gpu_multipliers//2), save_best='mIoU')
