...
class GaussianDiffusion:
    ...
    def p_mean_variance(self, model, x, t, clip_denoised=True, denoised_fn=None, model_kwargs=None,accelerator=None):
        """
    ...
    def training_losses(self, model, accelerator, x_start, timestep, model_kwargs=None, noise=None, skip_noise=False):
        """
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            loss = (target.float() - output.float()) ** 2
